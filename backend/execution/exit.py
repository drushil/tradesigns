...
def _rehydrated_open_trade(record: dict) -> dict:
    ...
    return {
        ...
        "playbook_lifecycle": record.get("playbook_lifecycle"),
        "session_window": record.get("session_window"),
        "primary_factor": record.get("primary_factor"),
        "factor_bucket": record.get("factor_bucket"),
        "regime_key": record.get("regime_key"),
        "data_quality_state": record.get("data_quality_state"),
        "data_quality_json": record.get("data_quality_json") or {},
        "cost_estimate_json": record.get("cost_estimate_json") or {},
        "estimated_spread_pct": record.get("estimated_spread_pct"),
        "estimated_total_cost_pct": record.get("estimated_total_cost_pct"),
